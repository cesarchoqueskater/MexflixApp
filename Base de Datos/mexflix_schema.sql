/*
Base de datos de Pelicula -> Mexflix
*/
...
INSERT INTO movieseries (imdb_id, title, plot, genres, author, actors, country, premiere, poster, trailer, rating, status, category) VALUES
	('tt0903747', 'Breaking Bad', 'A chemistry teacher diagnosed with terminal lung cancer teams up with his former student to cook and sell crystal meth.', 'Crime, Drama, Thriller', 'Vince Gilligan', 'Bryan Cranston, Anna Gunn, Aaron Paul, Dean Norris', 'USA', '2008', 'https://m.media-amazon.com/images/M/MV5BMjhiMzgxZTctNDc1Ni00OTIxLTlhMTYtZTA3ZWFkODRkNmE2XkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_SX300.jpg', 'https://www.youtube.com/watch?v=--z4YzxlT8o', 9.5, 4, 'Serie'),
	('tt2820466', 'Justice League: The Flashpoint Paradox', 'The Flash finds himself in a war torn alternate timeline and teams up with alternate versions of his fellow heroes to return home and restore the timeline.', 'Animation, Action, Adventure', 'Jay Oliva', 'Justin Chambers, C. Thomas Howell, Michael B. Jordan, Kevin McKidd', 'USA', '2013', 'https://m.media-amazon.com/images/M/MV5BMTgwNTljYzgtOTU3ZC00ZjhhLTk0YzItY2RiMWU0MGZlNzFjL2ltYWdlXkEyXkFqcGdeQXVyNDQ2MTMzODA@._V1_SX300.jpg', 'https://www.youtube.com/watch?v=xe0JiobQ98o', 8.1, 2, 'Movie'),
	...
	('tt4154796', 'Avengers: Infinity War - Part II', '', 'Action, Sci-Fi', 'Anthony Russo, Joe Russo', '', 'USA', '2019', 'https://m.media-amazon.com/images/M/MV5BMTc5MDE2ODcwNV5BMl5BanBnXkFtZTgwMzI2NzQ2NzM@._V1_SX300.jpg', '', 0, 1, 'Movie'),
	...
	('tt2527338', 'Star Wars: Episode IX', '', 'Action, Adventure, Fantasy', 'Colin Trevorrow', '', 'USA', '2019', 'https://m.media-amazon.com/images/M/MV5BMDljNTQ5ODItZmQwMy00M2ExLTljOTQtZTVjNGE2NTg0NGIxXkEyXkFqcGdeQXVyODkzNTgxMDg@._V1_SX300.jpg', '', 0, 1, 'Movie'),
...
/* Insertamos 2 usuarios por defecto */
INSERT INTO users (user, email, name, birthday, pass, role) VALUES
    ('@admin', 'admin@gmail.com', 'Admin', '1990-05-01', MD5('admin'), 'Admin'),
    ('@user', 'user@gmail.com', 'User', '1991-07-07', MD5('user'), 'User');
